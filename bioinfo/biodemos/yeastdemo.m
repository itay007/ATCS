...
% expression profiles. This example uses data from the microarray study of
% gene expression in yeast by DeRisi, et al. 1997. 
...
% almost all genes in _Saccharomyces cerevisiae_ during the metabolic shift
...
% expression level is marked as _NaN_. This indicates that no data was 
...
% techniques from the Statistics Toolbox(TM).
...
% components, the |pca| function in the Statistics Toolbox is used to
...
% If you have the Neural Network Toolbox(TM), you can use a self-organizing map
% (SOM) to cluster the data. 

% Check to see if the Neural Network Toolbox is installed
if ~exist('newsom.m','file')
    disp(sprintf(['The Self-Organizing Map section of this example\n'...
...
% genetic control of gene expression on a genomic scale. Science 24,
% 278(5338), 680-686. 

%%
% *<mailto:bioinfo-feedback@mathworks.com?subject=Enhancement%20for%20YEASTDEMO%20in%20Bioinformatics%20Toolbox%204.2 Suggest an enhancement for this example.>*
