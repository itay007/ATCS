...
for j=1:2:nargin-1
    ...
    switch(k)
        ...
        case {6,7} % SHOWCONSTRAINTS
            showConstraints  = bioinfoprivate.opttf(pval,okargs{k},mfilename);
        ...
        case {10,11} % SHOWNETWORK
            showNetwork  = bioinfoprivate.opttf(pval,okargs{k},mfilename);
        case 12 % QUANTILE
            if isempty(pval)
        ...
        case 13 %LINKAXES (undocummented)
            axisLink  = bioinfoprivate.opttf(pval,okargs{k},mfilename);
    end
end
