function [P PFWHH PEXT] = mspeaks(X,Y,varargin)
    ...
    for j=1:2:nargin-2
        ...
        elseif length(k)>1
            ...
            switch(k)
                ...
                case 5  %'denoising'
                    waveletEnable = bioinfoprivate.opttf(pval);
                    if isempty(waveletEnable)
                        error(message('bioinfo:mspeaks:denoisingInputOptionNotLogical', upper( char( okargs( k ) ) )));
                    end
                case 6  %'peaklocation'
